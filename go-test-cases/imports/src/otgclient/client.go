...
type Event struct {
	...
	RouteAdvertiseWithdraw *EventRouteAdvertiseWithdraw `json:"route_advertise_withdraw,omitempty"`

	// The optional container for rx rate threshold event configuration.
	RxRateThreshold *EventRxRateThreshold `json:"rx_rate_threshold,omitempty"`
}

// EventLink defines model for Event.Link.
...
// EventRouteAdvertiseWithdraw defines model for Event.RouteAdvertiseWithdraw.
...
// EventRxRateThreshold defines model for Event.RxRateThreshold.
...
// FlowLatencyMetrics defines model for Flow.Latency.Metrics.
...
type FlowMetric struct {
	...
	// the flow.
	Latency *MetricLatency `json:"latency,omitempty"`
	...
	// the flow.
	Timestamps *MetricTimestamp `json:"timestamps,omitempty"`
...
// FlowMetricGroupRequest defines model for Flow.MetricGroup.Request.
...
// FlowMetrics defines model for Flow.Metrics.
type FlowMetrics struct {
	...
	Latency *FlowLatencyMetrics `json:"latency,omitempty"`
...
type FlowMetricsRequest struct {
	...
	MetricGroups *FlowMetricGroupRequest `json:"metric_groups,omitempty"`
...
// MetricLatency defines model for Metric.Latency.
type MetricLatency struct {

	// Average latency in nanoseconds
	AverageNs *float64 `json:"average_ns,omitempty"`

	// Maximum latency in nanoseconds
	MaximumNs *float64 `json:"maximum_ns,omitempty"`

	// Minimum latency in nanoseconds
	MinimumNs *float64 `json:"minimum_ns,omitempty"`
}

// MetricTimestamp defines model for Metric.Timestamp.
type MetricTimestamp struct {

	// First timestamp in nanoseconds
	FirstTimestampNs *float64 `json:"first_timestamp_ns,omitempty"`

	// Last timestamp in nanoseconds
	LastTimestampNs *float64 `json:"last_timestamp_ns,omitempty"`
}
...
// SetRouteStateJSONBody defines parameters for SetRouteState.
type SetRouteStateJSONBody RouteState
...
// SetRouteStateRequestBody defines body for SetRouteState for application/json ContentType.
type SetRouteStateJSONRequestBody SetRouteStateJSONBody
...
type ClientInterface interface {
	...
	// SetRouteState request  with any body
	SetRouteStateWithBody(ctx context.Context, contentType string, body io.Reader) (*http.Response, error)

	SetRouteState(ctx context.Context, body SetRouteStateJSONRequestBody) (*http.Response, error)
...
func (c *Client) SetRouteStateWithBody(ctx context.Context, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewSetRouteStateRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SetRouteState(ctx context.Context, body SetRouteStateJSONRequestBody) (*http.Response, error) {
	req, err := NewSetRouteStateRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewSetRouteStateRequest calls the generic SetRouteState builder with application/json body
func NewSetRouteStateRequest(server string, body SetRouteStateJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSetRouteStateRequestWithBody(server, "application/json", bodyReader)
}

// NewSetRouteStateRequestWithBody generates requests for SetRouteState with any type of body
func NewSetRouteStateRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/control/routes")
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
type ClientWithResponsesInterface interface {
	...
	// SetRouteState request  with any body
	SetRouteStateWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader) (*SetRouteStateResponse, error)

	SetRouteStateWithResponse(ctx context.Context, body SetRouteStateJSONRequestBody) (*SetRouteStateResponse, error)
...
// Status returns HTTPResponse.Status
func (r SetRouteStateResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r SetRouteStateResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// SetRouteStateWithBodyWithResponse request with arbitrary body returning *SetRouteStateResponse
func (c *ClientWithResponses) SetRouteStateWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader) (*SetRouteStateResponse, error) {
	rsp, err := c.SetRouteStateWithBody(ctx, contentType, body)
	if err != nil {
		return nil, err
	}
	return ParseSetRouteStateResponse(rsp)
}

func (c *ClientWithResponses) SetRouteStateWithResponse(ctx context.Context, body SetRouteStateJSONRequestBody) (*SetRouteStateResponse, error) {
	rsp, err := c.SetRouteState(ctx, body)
	if err != nil {
		return nil, err
	}
	return ParseSetRouteStateResponse(rsp)
...
// ParseSetRouteStateResponse parses an HTTP response from a SetRouteStateWithResponse call
func ParseSetRouteStateResponse(rsp *http.Response) (*SetRouteStateResponse, error) {
	bodyBytes, err := ioutil.ReadAll(rsp.Body)
	defer rsp.Body.Close()
	if err != nil {
		return nil, err
	...
	response := &SetRouteStateResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
